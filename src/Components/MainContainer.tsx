...
export function MainContainer() {
    return (
        <div className="flex flex-col gap-4 h-[calc(100vh_-_15vh_-_60px)] items-start justify-center">
            <h1 className="flex flex-col text-left text-5xl text-zinc-900 leading-none font-playFair font-bold">
                Hello!
            ...
            <div className="flex flex-col gap-12">
                ...
                <p className="text-justify text-zinc-500 text-xs">
